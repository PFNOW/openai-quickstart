...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, help='Type of the Large Language Model, including ollama and openai.')
        ...
        self.parser.add_argument('--style', type=str, help='The style for translating the original book.')
