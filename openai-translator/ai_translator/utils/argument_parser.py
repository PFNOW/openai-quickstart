...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate PDF book.')
        ...
        self.parser.add_argument('--openai_base_url', type=str, help='The API URL for OpenAIModel. Required if model_type is "OpenAIModel".')
        self.parser.add_argument('--book', type=str, help='PDF file to translate.')
        self.parser.add_argument('--language', type=str, help='Translate language.')
